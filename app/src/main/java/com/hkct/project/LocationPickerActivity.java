                            ...
                            mapboxMap.getStyle(new Style.OnStyleLoaded() {
                                ...
                                public void onStyleLoaded(@NonNull Style style) {
                                    if (style.getLayer(DROPPED_MARKER_LAYER_ID) != null) {
                                        ...
                                        String addressText = String.valueOf(feature.placeName());
                                        Log.d("===", "feature.placeName():" + addressText);


//                                        Intent intent = getIntent();
//                                        intent.putExtra("cloth", feature.placeName());
...
//                                        finish();
                                        ...
                                        bundle.putString("placeName", addressText);
                                        Log.d("===", "result:" + addressText);
