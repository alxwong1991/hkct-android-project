...
public class LocationPickerActivity2 extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        LocationPickerActivity2.this.mapboxMap = mapboxMap;
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull final Style style) {
                ...
                hoveringMarker = new ImageView(LocationPickerActivity2.this);
                    ...
                    public void onClick(View view) {
                        if (hoveringMarker.getVisibility() == View.VISIBLE) {
                            ...
                            selectLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(LocationPickerActivity2.this, R.color.ivory_black));
                        ...
                        if (results.size() > 0) {
                            ...
                            mapboxMap.getStyle(new Style.OnStyleLoaded() {
                                ...
                                public void onStyleLoaded(@NonNull Style style) {
                                    if (style.getLayer(DROPPED_MARKER_LAYER_ID) != null) {
                                        Toast.makeText(LocationPickerActivity2.this,
